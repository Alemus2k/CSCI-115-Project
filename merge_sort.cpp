...
long long mergeHelper(vector<int>& arr, int left, int right) {
...
long long mergeSort(vector<int>& arr) {
    return mergeHelper(arr, 0, (int)arr.size() - 1);
}
...
int main() {
    ...
    cout << "======================================================" << endl;
    cout << "  MERGE SORT — Performance Study" << endl;
    cout << "======================================================" << endl;
